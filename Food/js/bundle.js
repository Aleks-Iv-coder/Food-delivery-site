...
// Calculator
function calc() {
  var result = document.querySelector('.calculating__result span'); // getting element were we will to output result

  var sex, height, weight, age, ratio; // creating a some needed variables
  ...
  initLocalSettings('.calculating__choose_big div', 'calculating__choose-item_active'); // Calculating calories
  ...
  calcTotal(); // getting data from the static elements 
    ...
    elements.forEach(function (elem) {
      elem.addEventListener('click', function (e) {
        if (e.target.getAttribute('data-ratio')) {
          // checking for the "data-"" atribut
          ratio = +e.target.getAttribute('data-ratio');
          localStorage.setItem('ratio', +e.target.getAttribute('data-ratio'));
        } else {
          // if there isn't the "data-"", than receiving an elements by id 
...
function cards() {
    ...
    _createClass(MenuCard, [{
      ...
      value: function render() {
        ...
        if (this.classes.length === 0) {
          ...
          this.classes.forEach(function (classNames) {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_3__.getResurce)('http://localhost:3000/menu').then(function (data) {
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      e.preventDefault(); // creating spinner element that will be shown after sending the request form

      var statusMessage = document.createElement('img');
      statusMessage.src = message.loading;
      statusMessage.style.cssText = "\n                display: block;\n                margin: 20px auto;\n            "; // rendering the spinner element in the form

      form.insertAdjacentElement('afterend', statusMessage); // Putting the all form data to the new object (using the FormData class)

      var formData = new FormData(form); // СОЗДАЁМ ОБЫЧНЫЙ ОБЪЕКТ ИЗ formData
      ...
      */
      ...
      var json = JSON.stringify(Object.fromEntries(formData.entries())); // Sending the POST request
...
function closeModal(modalSelector) {
  var modal = document.querySelector(modalSelector); // modal.classList.toggle('show');
...
function slider(_ref) {
  ...
  var slides = document.querySelectorAll(slide),
      // array of wrappers for each slide
  slider = document.querySelector(container),
      // general container of the whole carousel
  prev = document.querySelector(prevArow),
      // left arrow
  next = document.querySelector(nextArrow),
      // right arrow
  total = document.querySelector(totalCounter),
      // element of total number of slides
  current = document.querySelector(currentCounter),
      // element of counter of the current slide
  slidesWreper = document.querySelector(wrapper),
      // wrapper for whole slider (slides and block of slide's marcers)
  slidesField = document.querySelector(field),
      // field for the slides block
  width = window.getComputedStyle(slidesWreper).width;
  var slideIndex = 1; // slide number

  var offset = 0; // the width of slider window
  // Slides's switcher

  function slidesToggel(elem, num) {
    elem.style.transform = "translateX(-".concat(num, "px)"); // putting slide's position that needed
  }
  ...
  function cucrentNum(items, elem, index) {
    if (items.length < 10) {
      elem.textContent = "0".concat(index);
    } else {
  ...
  ;
  cucrentNum(slides, current, slideIndex); // service function for manage slider
  ...
  slider.style.position = 'relative'; // Indicator's wraper

  var indicators = document.createElement('ol'),
      dots = [];
  indicators.classList.add('carousel-indicators');
  slider.append(indicators); // Styling an indicators
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__.default)('.timer', '2021/01/28');
...
/*!*********************************!*\
  ...
  \*********************************/
/*! namespace exports */
/*! export getResurce [provided] [no usage info] [missing usage info prevents renaming] */
...
/* harmony export */   "getResurce": function() { return /* binding */ getResurce; }
/* harmony export */ });
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.concat */ "./node_modules/core-js/modules/es.array.concat.js");
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__);
